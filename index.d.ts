 ...
 */
    type iter = <T>(source: Iterable<T> | Iterator<T> | Generator<T>) => Iter<T>;
    ...
    namespace iter {
         ...
         */
        let fromObject: <U>(obj: any, filter?: TestProvider<string>) => Iter<[string, U]>;
        /**
         ...
         * @returns {IterKvp<string, any>} an Iter instance with a sequence of [key, value] pairs corresponding to the object's properties
         */
        let fromObjectOwn: <U>(obj: any, filter?: TestProvider<string>) => Iter<[string, U]>;
        /**
         ...
         * @returns {IterKvp<string, any>} an Iter instance with a sequence of [key, value] pairs corresponding to the object's properties
         */
        let generate: <T>(obj: (index: number) => T, times: number) => Iter<T>
        /**
         ...
         */    
        let reflect: (object: any, recurse?: boolean, filter?: TestProvider<string>) => Iter<[string, PropDescriptor]>; 
        ...
        class Iter<T> implements Iterable<T> {
            ...
            */
             ...
             */
            groupBy<K>(key: KeyProvider<K>, map: KeyProvider<T>): Iter<[K, T[]]>;
            /**
             ...
             * @returns {Iter<T>} A sequence of all items after the skipped ones
             */
            skipWhile(callback: (element: T)=>boolean): Iter<T>;
            /**
             ...
             * @returns {Iter<T>} a sequence of the taken items
             */
            takeWhile(callback: (element: T)=>boolean): Iter<T>;
            /**
             ...
             */
            map(callback: KeyProvider2<T>, thisArg?: any): Iter<T>;
            /**
            ...
            /**
             * Assuming the sequence contains [key, value] pairs, return a sequence of the keys
             * 
